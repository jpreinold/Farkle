...
define(['./workbox-e16c6738'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    request,
    url
  }) => request.destination === "image" && url.origin === self.location.origin, new workbox.CacheFirst({
